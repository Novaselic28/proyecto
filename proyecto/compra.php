...
if (isset($_GET['nombre'])) {
    ...
    $query = "SELECT Img, Nombre, descripcion,Compra FROM videojuegos WHERE Nombre = '$nombre'";
...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/estiloren.css">
  </head>
  <body>
    <header>
      <div class="logo">
